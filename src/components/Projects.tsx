      ...
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Featured <span className="bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-transparent">Projects</span>
          </h2>
              ...
              <div className="relative p-6 h-full flex flex-col">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 text-sm bg-slate-700/50 text-pink-300 rounded-full border border-pink-500/30"
                    >
                      {tech}
                    </span>
                  ))}
